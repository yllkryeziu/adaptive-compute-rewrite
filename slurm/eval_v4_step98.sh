#!/bin/bash
#SBATCH --job-name=eval_v4_step98
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
# --- Configuration ---
MODEL_PATH="/p/project1/envcomp/yll/adaptive-compute-rewrite/results/nemo_simpo_32b_v4_hf/step_98"
TASK_NAME="math500"
...
echo "Starting evaluation: V4 Step 98 - temp=0.5, top_p=0.95"
...
skythought evaluate \
    ...
    --batch-size 16 \
    --n 1 \
    --result-dir $OUTPUT_DIR/nemo_simpo_32b_v4_step98_temp \
    --overwrite
