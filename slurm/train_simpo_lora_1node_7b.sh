#!/bin/bash
#SBATCH --job-name=simpo-lora-1node-7b
#SBATCH --nodes=1
...
CONFIG_FILE="skythought/train/LLaMA-Factory/examples/train_lora/qwen2_7b_lora_simpo.yaml"

# --- Execution ---
echo "Starting LoRA training (7B) on 1 node..."
...
torchrun \
    ...
    skythought/train/LLaMA-Factory/examples/train_lora/qwen2_7b_lora_simpo.yaml
