...
class MathTaskHandler(TaskHandler):
    ...
    def check_correctness(self, problem, generation):
        ...
        return math_equal(pred, answer), pred, answer
    ...
    def update_results(self, problem, response):
        ...
        if curr_res[0]:
            ...
            response_entry["reason"] = f"Correct answer: {curr_res[2]}, predicted answer: {curr_res[1]}"
        else:
            response_entry["correctness"] = False
            response_entry["reason"] = f"Incorrect answer: {curr_res[2]}, predicted answer: {curr_res[1]}"
